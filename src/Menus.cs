...
{GetLine(insert, "liMenuItemTooltipArgument", tooltipArgument ?? "-1", fromEnd, index)}";
    ...
    public static UndertaleGameObject CreateMenu(this UndertaleData data, string name,
        params WysMenuOption[] options) => data.CreateMenu(name, new WysMenuSettings(), options);
        ...
        string? tooltipScript = null, string? tooltipArgument = null)
    {
        ...
        UndertaleGameObject menu = data.CreateMenu($"toggle_{name}", new WysMenuSettings
        {
    ...
    public static WysMenuOption CreateToggleOption(this UndertaleData data, string name, string internalName,
        ...
        string? tooltipScript = null, string? tooltipArgument = null)
    {
        string menuName = data.CreateToggleMenu(internalName, setCode, preselectCode, tooltipScript, tooltipArgument);
        ...
        string changeCode, string returnCode, double step, bool enableUiSounds = true)
    {
        ...
        UndertaleGameObject menu = data.CreateMenu($"change_{name}", new WysMenuSettings
        {
    ...
    {
        (string menuName, string returnName) = data.CreateChangeMenu(internalName, changeCode, returnCode, step);
